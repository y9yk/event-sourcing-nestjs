...
let AggregateRepository = class AggregateRepository {
    constructor(eventStore) {
        this.eventStore = eventStore;
    }
    getById(type, aggregateName, aggregateId) {
        return __awaiter(this, void 0, void 0, function* () {
            const aggregateEvents = yield this.eventStore.getEvents(aggregateName, aggregateId);
...
AggregateRepository = __decorate([
    ...
    __metadata("design:paramtypes", [eventstore_1.EventStore])
], AggregateRepository);
